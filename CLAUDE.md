...
├── .claude-plugin/
│   └── marketplace.json   # Test Double marketplace manifest (lists han, han-core, han-planning, han-coding, han-github, han-reporting, han-feedback, han-atlassian, han-linear, han-plugin-builder, han-experimental)
...
├── han-coding/         # Coding plugin: tdd, refactor, code-review, code-overview, architectural-analysis, test-planning, investigate, coding-standard, implement-work-items (the skills for working in code; depends on han-core; bundled by the han meta-plugin)
│   ├── .claude-plugin/
│   │   └── plugin.json
...
├── han-experimental/   # Opt-in experimental plugin: review-skill-or-agent (depends on han-core + han-plugin-builder; NOT bundled by the han meta-plugin)
│   ├── .claude-plugin/
│   │   └── plugin.json
│   └── skills/         # review-skill-or-agent (SKILL.md + references/ + scripts/)
