...
- **Indexes stay complete, not counted.** Every skill in `han.core/skills/`, `han.planning/skills/`, `han.coding/skills/`, `han.github/skills/`, `han.reporting/skills/`, `han.feedback/skills/`, `han.atlassian/skills/`, and `han.plugin-builder/skills/` has a long-form doc in `docs/skills/` and an entry in the skills index; same for agents in `han.core/agents/` and `docs/agents/`. Verify the indexes list every entity when editing them, rather than tracking a running total.
