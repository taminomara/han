...
├── han-atlassian/      # Opt-in Atlassian plugin: markdown-to-confluence, project-documentation-to-confluence, investigate-to-confluence, plan-a-feature-to-confluence, work-items-to-jira (depends on han-core; requires the Atlassian MCP server; NOT bundled by the han meta-plugin)
