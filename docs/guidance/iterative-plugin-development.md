...
No discussion-only iterations. Every iteration must update the actual files — SKILL.md, agent definitions, plugin.json, reference files — to reflect current decisions. Writing forces precision that discussion alone does not.
