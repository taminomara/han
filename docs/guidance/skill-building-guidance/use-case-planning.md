...
- **Tools:** Read, Grep, Glob, Agent (codebase-explorer)
...
- **Tools:** Read, Grep, Glob, Agent (content-auditor)
...
Then:
  - Skill triggers (not a sibling like coding-standard or architectural-decision-record)
  - Codebase explorer agent discovers auth-related files
