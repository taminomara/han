...
See [`graceful-degradation.md`](graceful-degradation.md) for the detection script pattern and implementation rules. See [`han/skills/code-review/scripts/detect-review-context.sh`](../../han/skills/code-review/scripts/detect-review-context.sh) for the canonical detection script implementation.
