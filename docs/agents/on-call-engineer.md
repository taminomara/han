...
- **Bug triage or root-cause investigation after an incident.** Use [`/investigate`](../skills/investigate.md). This agent is for prevention before the page, not diagnosis after.
