...
- **gh CLI required.** Without `gh`, the skill stops immediately and tells the user to install it.
...
- **Summary** — leading with the central mechanism, followed by supporting context.
