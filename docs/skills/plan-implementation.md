...
Operator documentation for the `/plan-implementation` skill in the han plugin. This document helps you decide *when* and *how* to use the skill. For what the skill does internally, read the skill definition at [`plugin/skills/plan-implementation/SKILL.md`](../../plugin/skills/plan-implementation/SKILL.md).
