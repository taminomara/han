...
This file ALSO consolidates the project-manager's per-round facilitation output —
...
produced:` and `Changed in plan:` backfilled during the project-manager's synthesis
step.
