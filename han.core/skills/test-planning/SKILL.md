...
5. **Technical Reference → Deferred Tests** — Items the test-engineer excluded due to brittleness risk.
6. **Technical Reference → Dropped Edge Cases** — Items the edge-case-explorer intentionally excluded.
